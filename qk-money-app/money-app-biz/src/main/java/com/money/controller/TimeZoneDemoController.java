...
@TZProcess
@RestController
@RequestMapping("/demo/timeZone")
public class TimeZoneDemoController {

    @TZRep
    @PostMapping
    public TimeZoneVO test1(@TZParam TimeZoneDTO dto) {
        // 例子请求 curl "http://localhost:9000/qk-money/demo/timeZone" -H "Content-Type: application/x-www-form-urlencoded" -H "X-qk-timezone: GMT+09:00" --data-raw "dateTime=2022-05-13 13:15:00&localDateTime=2022-05-13 13:15:00"
